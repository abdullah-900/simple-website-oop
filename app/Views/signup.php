...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="/signup/process" method="POST">
    <div>
      ...
      <?php
if (isset($_SESSION["is_signup_success"])) {
    $signupstate=$_SESSION["is_signup_success"];
   unset($_SESSION["is_signup_success"]);

if($signupstate) {
echo "<p class='success text-center'>";
echo htmlspecialchars("you successfully signed up");
echo "</p>";
}elseif ($signupstate===false && isset($_SESSION["errors"]) ){
$errors=$_SESSION["errors"];
unset($_SESSION["errors"]);
foreach($errors as $error){
    echo "<p class='failed text-center'>"; 
